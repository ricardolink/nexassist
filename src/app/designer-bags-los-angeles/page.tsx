...
const cfg: ServiceLandingConfig = {
  ...
  items: [
    ...
    {
      name: "Bottega Veneta",
      sub: "Jodie · Cassette · Andiamo · Arco",
      tags: ["Investment Pieces", "Intrecciato", "Seasonal Colors"],
      img: "https://images.unsplash.com/photo-1591561954555-607968c989ab?w=800&q=80",
      color: "#f97316",
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1604422378960-69f3e23e3d44?w=800&q=80",
      color: "#a78bfa",
    },
  ],
